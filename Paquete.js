    ...
    <ScrollView>
      <View style={styles.container}>
          <View style={styles.titulo}>
            <Text style={styles.tituloTitulo}>{paquete.nombre}</Text>
          ...
          <View style={styles.imageContainer}>
            ...
            <Image source={{uri:`${paquete.imagen}`}} style={styles.image}/>
          </View>
      </View>
      <View style={styles.container2}>
        <View style={styles.acercaDe} >
          ...
          <View style={styles.textoAcercaDePadre}>
            <Text style={styles.textoAcercaDe}>👥 {paquete.cantidadPersonas}</Text>
            <Text  style={styles.textoAcercaDe}>📅 Se puede user hasta el 03/09/2021</Text>
            <Text  style={styles.textoAcercaDe}>🎁 {paquete.ubicacion} </Text>
        ...
        <View style={styles.comprarBoton}>
          <Text onPress={()=>props.navigation.navigate('carrito')} style={styles.comprarBotonTexto}>Comprar esta BigBox</Text>
        </View>
        <View>
